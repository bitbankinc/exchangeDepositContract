...
contract ExchangeDeposit {
    ...
    function getProxyTarget() internal pure returns (address payable) {
        return address(0);
    }
     ...
     */
    function exchangeDepositorAddress() public view returns (address payable) {
    ...
    {
        return address(new Proxy{ salt: salt }(address(this)));
    }
